...
class Mixin:
    def VirtualStateTomography(self, node1, node2, num_required=10000, label_in='Physical',resource_type='Physical'):
    ...
    def PrototypeVirtualStateTomography(self, process, node1, node2, num_required=10000, label_in='Physical',resource_type='Physical'):
        ...
        while process['isSuccess'] < num_required:
            ...
            info = (Bell, node1, node2, resource_type, process, num_required, num_measure_per_stab)

            self.env.process(self._independentVirtualStateTomography(info))
            
    def _independentVirtualStateTomography(self, info):

        Bell, node1, node2, resource_type, process, num_required, num_measure_per_stab = info
